...
var IncomeTaxed = React.createClass({
	...
	render: function() {
		...
		return (
			...
			<input tabIndex="4" className={class_arr.join(' ')} type="text" defaultValue={this.props.amount} value={this.props.amount} onChange={this.handleChange} readOnly={this.props.readOnly} />
			</div>
			<div className="form__errors">
				{errors}
			</div>
...
var MandatoryPC = React.createClass({
	...
	render: function() {
		...
		return (
			...
			<input tabIndex="5" className={class_arr.join(' ')} type="text" defaultValue={this.props.amount} value={this.props.amount} onChange = {this.handleChange} readOnly={this.props.readOnly}/>
			</div>
			<div className="form__errors">
				{errors}
			</div>
